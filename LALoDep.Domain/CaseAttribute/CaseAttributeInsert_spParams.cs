...
{
    public class CaseAttributeInsert_spParams
    {
    ...
    public class CaseAttributeGetByType_spParams
    {
        public int CaseID { get; set; }
        public int CaseAttributeTypeID { get; set; }
    ...
    public class CaseAttributeGetByType_spResult<T>
    {
        public int CaseAttributeID { get; set; }
        public T CaseAttributeGenericValue { get; set; }
