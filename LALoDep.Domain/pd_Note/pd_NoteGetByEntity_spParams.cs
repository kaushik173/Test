...
{
    public class pd_NoteGetByEntity_spParams
    {
        public int EntityPrimaryKeyID { get; set; }
        public int EntityCodeSystemValueTypeID { get; set; }
        public int EntityCodeTypeSystemValueTypeID { get; set; }
        public int UserID { get; set; }
        public Guid BatchLogJobID { get; set; }
    }
    public class pd_NoteGetByEntity_spResult
    {
