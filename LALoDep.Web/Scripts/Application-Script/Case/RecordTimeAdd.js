...
$("#btnSaveAndGoToNotes").on("click", function () {
    SaveData(6)
});
$("#btnSaveAndMain").on("click", function () {
    SaveData(1)
});
$("#btnSaveAndClosePopup").on("click", function () {

    SaveData(5)
});

$("#btnSaveandList").on("click", function () {
    SaveData(2)
});
...
$("#btnSaveandAddPopup").on("click", function () {
    SaveData(7)
});
$("#btnCancel").on("click", function () {
	validateTabClose = false;
    if (Contains(window.location.href, "arId=")) {
        window.location.href = "/Case/RecordTime?arId=" + getParameterByName("arId");
    } else {
        window.location.href = "/Case/RecordTime";
    }
...
function ajaxREquestForSave(data, buttonId) {
    var ajaxUrl = '/Case/RecordTimeAddSave';
    if (Contains(window.location.href, "arId=")) {
        ajaxUrl += "?arId=" + getParameterByName("arId");
    }
            ...
            if (result.isSuccess) {
                ...
                if (buttonId == 7) {
                    ...
                    setTimeout(function () {
                        ...
                        window.location.href = '/Case/RecordTimeAdd?popup=true' + $referralId + '&startDate=' + $('#StartDate').val();
                    }, 0);
                    return false;
                }
                if (result.URL != '') {
