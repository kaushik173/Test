...
!function ($) {
    ...
    BootstrapTable.prototype.initHeader = function () {
        ...
        $.each(this.options.columns, function (i, column) {
            ...
            html.push('<th',
                ...
                '>');
            html.push(sprintf('<div class=" %s">', that.options.sortable && column.sortable ?
                'sortable' : ''));
    ...
    BootstrapTable.prototype.initToolbar = function () {
        ...
        if (this.options.search) {
            html = [];
            html.push(
                '<div class="pull-' + this.options.searchAlign + ' search"> <div class="input-group"> ',
                    sprintf('<input class="form-control" type="text" placeholder="%s"> <span class="input-group-addon"><i class="glyphicon glyphicon-search"></i></span>',
